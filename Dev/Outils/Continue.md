...
- Workflow 100 % terminal, agnostique de l'éditeur, avec commits git automatiques → [[Aider]].
- Agent autonome à validation pas-à-pas (Plan/Act) et intégration MCP de première classe → [[Cline]].
