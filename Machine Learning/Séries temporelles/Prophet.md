...
- Beaucoup de séries (milliers, millions) à prévoir vite → [[statsforecast]].
- Modèles neuronaux récents ou covariables riches → [[neuralforecast]], [[darts]].
...
- [[darts]] — intègre Prophet comme l'un de ses modèles classiques.
