...
pitch: Des lignes, des colonnes, une cible — la famille de problèmes la plus courante en entreprise, et celle où le boosting reste devant.
...
> Des lignes, des colonnes, une cible — la famille de problèmes la plus courante en entreprise, et celle où le boosting reste devant.

## Ce qu'il faut comprendre

- **Ce dossier ne range pas « tout ce qui se met dans un DataFrame ».** Manipuler et transformer des tables relève de [[DataFrames]] et de [[Data & pipelines]] ; modéliser une table dont une colonne est la cible relève d'ici. Le socle généraliste, lui, est au niveau du domaine : [[Scikit-Learn]] fait déjà du tabulaire, ce dossier ne contient que ce qui va plus loin que lui.
...
- Un modèle de référence avant tout ça → [[Scikit-Learn]], au niveau du domaine.
