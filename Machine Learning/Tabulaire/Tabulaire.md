...
- **Le rendement se déplace vite du modèle vers les variables**, et cette moitié du dossier pèse plus lourd que l'autre. [[Ingénierie des caractéristiques]] est le premier levier ; [[Encodage des variables catégorielles]] le deuxième, et le plus mal fait — un encodage par la cible fuit si on l'ajuste sur les mêmes lignes que le modèle, c'est une source classique de [[Data leakage]], cf. [[Évaluation de modèles]]. [[Mise à l'échelle]] ne sert pas aux arbres mais reste nécessaire aux modèles linéaires et aux distances. [[Sélection de variables]] arrive en dernier.
