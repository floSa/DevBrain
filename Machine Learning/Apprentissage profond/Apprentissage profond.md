...
- L'interprétabilité de ces réseaux est un domaine à part entière, et ses notions vivent avec ses outils dans [[Interprétabilité]] : [[Interprétabilité mécaniste]], [[Sparse autoencoders]], [[Superposition]], [[Probing]], [[Attribution par gradient]].
