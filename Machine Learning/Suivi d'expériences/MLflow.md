...
- Dashboards de visualisation très riches et collaboration temps réel → [[Weights & Biases]].
- MLOps tout-en-un (données, pipelines, orchestration) clé en main → [[ClearML]].
- Suivi ultra-léger sans serveur à gérer → [[Aim]].
...
- S'intègre avec : [[PyTorch]], [[Scikit-Learn]], [[XGBoost]], [[Optuna]].
