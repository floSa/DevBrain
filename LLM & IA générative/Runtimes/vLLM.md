...
- Poste de dev / prototypage simple, ou pas de GPU → [[Ollama]] ou [[llama.cpp]].
- Stack et endpoints managés Hugging Face → [[TGI]].
- Pipelines LLM programmables avec cache de préfixes poussé → [[SGLang]].
...
- Modèles servis depuis [[HuggingFace]] (poids transformers).
- Endpoint OpenAI-compatible : se branche comme une API [[FastAPI]] devant un orchestrateur.
