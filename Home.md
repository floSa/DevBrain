...
`Dev/` n'existe plus. Il reste **`Wiki/Concepts/`** — **126** notions `concept/*` que
...
statistiques, mathématiques, data, signal, sécurité IA, LLM, le renforcement et les
séries temporelles. Restent le machine learning (67), le deep learning (52) et le
NLP (7).
