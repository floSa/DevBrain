...
`Dev/` n'existe plus. Il reste **`Wiki/Concepts/`** — **139** notions `concept/*` que
le lot 4 descendra dans l'arbre, et **3** `MOC/Concepts/` avec elles : ces pages sont
...
statistiques, mathématiques, data, signal, sécurité IA, LLM et le renforcement. Restent
le machine learning (67), le deep learning (52), les séries temporelles (13) et le
NLP (7).
